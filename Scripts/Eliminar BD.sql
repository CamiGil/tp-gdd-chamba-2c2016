...
DROP PROCEDURE CHAMBA.OBTENER_NUEVO_ID_AGENDA
DROP PROCEDURE CHAMBA.BUSQUEDA_PROFESIONAL_ESPECIALIDADES
DROP PROCEDURE CHAMBA.BUSQUEDA_PROFESIONAL_REFINADO_POR_TIPO
